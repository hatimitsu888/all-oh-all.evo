...
# メッセージ
execute if score @s all.settings.menu matches 10 run data modify storage all: setting.menu.text set value {text: "> 自動回収を オフ にしました <"}
execute if score @s all.settings.menu matches 10 run data modify storage all: setting.menu.text set value {text: "> 自動回収を オン にしました <"}
