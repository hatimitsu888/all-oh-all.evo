...
execute if data storage all: {pos_data:{facing: "u"}} rotated 0 -90 run function all_common:area_break/break with storage all: area
execute if data storage all: {pos_data:{facing: "d"}} rotated 0 90 run function all_common:area_break/break with storage all: area
