...
execute unless data entity @s SelectedItem.components."minecraft:enchantments"."minecraft:silk_touch" at @e[distance=..1.75, tag=all.break_pos] run function all_common:all/xp/
