...
#再帰
execute if score #break_cnt all.break_cnt < #all.limit all.settings at @e[tag=all.break_pos, distance=..1.5] run function all_mine:mine/bulk/concrete/light_gray_concrete
