...
#下
    ...
    execute positioned ~1 ~-1 ~ if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~ ~-1 ~1 if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~ ~-1 ~ if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~ ~-1 ~-1 if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~-1 ~-1 ~1 if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~-1 ~-1 ~ if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
    execute positioned ~-1 ~-1 ~-1 if block ~ ~ ~ tube_coral_block run function all_common:all/bulk/summon
